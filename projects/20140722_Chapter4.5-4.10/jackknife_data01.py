...
print 'Dataset mean = %.4f'%np.mean(data)
print 'Dataset std dev = %.4f'%np.std(data)
...
pdf1_theory = norm(data.std(), 1. / np.sqrt(2 * (m - 1)))
...
print 'Jackknife on interquartile: mu2, sigma_mu2 = %.4f, %.4f'%(mu2,sigma_mu2)
